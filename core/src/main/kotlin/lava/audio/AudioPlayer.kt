...
import lava.ecs.components.audio.AudioChannels

interface SoundAssets {
    val soundEffects: Map<String, Map<String,List<TurboSound>>>
}
...
class AudioPlayer(private val defaultVolume : Float = 1f, val soundAssets: SoundAssets) {
    ...
    private fun getSound(category: String, sound: String): TurboSound {
        return soundAssets.soundEffects[category]!![sound]!!.random()
    }
